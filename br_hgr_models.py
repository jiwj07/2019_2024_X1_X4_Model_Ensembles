...
print("2019-2024 X1-X4 River Data.csv")
...
df_results.to_csv('2019-2024 X1-X4 Results Ensemble KFold.csv', mode='a', index=False, header=False)
print(df_results)
